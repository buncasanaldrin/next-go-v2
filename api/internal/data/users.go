...
var (
	...
	ErrDuplicateCode  = errors.New("models: duplicate code")
)
...
func (m UserModel) GetForToken(tokenScope, tokenPlaintext string) (*User, error) {
	...
	query := `
  SELECT users.id, users.created_at, users.first_name, users.last_name, users.email, users.password_hash, users.activated, users.version
  FROM users
  INNER JOIN tokens
